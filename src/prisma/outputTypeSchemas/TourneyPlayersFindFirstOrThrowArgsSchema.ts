...
export const TourneyPlayersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TourneyPlayersFindFirstOrThrowArgs> = z.object({
...
export default TourneyPlayersFindFirstOrThrowArgsSchema;
