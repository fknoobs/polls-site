...
export const TourneyTeamsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TourneyTeamsFindFirstOrThrowArgs> = z.object({
...
export default TourneyTeamsFindFirstOrThrowArgsSchema;
